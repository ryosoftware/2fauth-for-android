    ...
    private void addGroup() {
        UI.startRotationAnimation(mAddGroupDataButton, Constants.BUTTON_CLICK_ANIMATION_BEFORE_START_ACTION_DEGREES, Constants.BUTTON_360_DEGREES_ROTATION_ANIMATION_DURATION, new UI.OnAnimationEndListener() {
            ...
            public void onAnimationEnd(View view) {
                if (isAdded()) {
                    final String group_name_valid_regexp = mServerIdentity.isApiVersionGreaterThan(Constants.MIN_API_VERSION_SUPPORTING_APOSTROPHE_IN_GROUP_NAME, true) ? Constants.GROUP_NAME_VALID_REGEXP_WITH_APOSTROPHE_SUPPORT : Constants.GROUP_NAME_VALID_REGEXP_WITHOUT_APOSTROPHE_SUPPORT;
