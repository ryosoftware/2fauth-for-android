...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(@NotNull final SQLiteDatabase database, final int old_version, final int new_version) {
        ...
        if (old_version < 5) {
            database.execSQL(String.format("ALTER TABLE %s ADD COLUMN %s TEXT", TwoFactorServerIdentitiesHelper.TABLE_NAME, TwoFactorServerIdentity.API_VERSION));
        }
    }
