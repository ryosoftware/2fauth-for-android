...
public class SelectHowAddAccountDataActivity extends BaseActivity implements OnServerIdentitiesLoadedListener, OnQRDecodedListener, OnClickListener {
    ...
    protected void onCreate(@Nullable final Bundle saved_instance_state) {
        ...
        setContentView(R.layout.select_how_add_account_data_activity);
