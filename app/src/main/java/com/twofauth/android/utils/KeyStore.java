...
public class KeyStore {
    ...
    public static void addKeyAlias(@NotNull final String key_alias, final boolean authentication_required) throws Exception {
        final java.security.KeyStore keystore = java.security.KeyStore.getInstance(PROVIDER_NAME);
        keystore.load(null);
    ...
    private static@Nullable SecretKey getKeyAlias(@NotNull final String key_alias) throws Exception {
        final java.security.KeyStore keystore = java.security.KeyStore.getInstance(PROVIDER_NAME);
        keystore.load(null);
    ...
    public static@Nullable String encrypt(@NotNull final String key_alias, @NotNull final String data) throws Exception {
    ...
    public static @Nullable String decrypt(@NotNull final String key_alias, @NotNull final String data) throws Exception {
        final SecretKey key = getKeyAlias(key_alias);
        if (key != null) {
    ...
    public static @NotNull byte[] getRandom(int length) {
